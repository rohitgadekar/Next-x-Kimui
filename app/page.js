"use client";
import { Button, Toaster, useToast } from "@rohitgadekar/kimui";
...
export default function Home() {
  ...
  const showToast = () => {
    toast({
      title: "Horray!",
      description: "Thanks for using kimui.",
    });
  };
    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20  ">
      <main className="flex flex-col  gap-8 row-start-2 items-center sm:items-start">
        ...
        <div className="flex flex-wrap gap-2 items-center justify-center">
          ...
          <h1 className="text-4xl">kimui</h1>
        </div>
        ...
        <Button onClick={showToast}>get started</Button>
      </main>
      <Toaster />
    </div>
  );
