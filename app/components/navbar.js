  ...
  return (
    <nav className="bg-black p-4">
      <div className="container mx-auto">
        <div className="flex flex-row justify-between items-center">
          <Link href={"/"}>
            <div className="flex items-center space-x-2 z-50">
              <GiEagleHead size={30} color="white" />
              <span className="text-2xl font-semibold text-white">KIMUI</span>
            </div>
          </Link>
        ...
        <div
          className={`fixed inset-0  bg-black z-40 flex items-center justify-center transition-opacity duration-300 ease-in-out ${
            isMenuOpen
